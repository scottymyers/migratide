# File: /home/ragequit/migrainetracker/migrainetracker/settings.py
...
ALLOWED_HOSTS = [config('ALLOWED_HOSTS', default='ragequit.pythonanywhere.com').split()]
...
MIDDLEWARE = [
    ...
    # 'django.middleware.common.BrokenLinkEmailsMiddleware',  # Uncomment if you want 404 emails
]
